<x-layouts.app :title="__('Daftar Produk')">
    ...
    <div class="flex justify-between mb-4">
        <form method="get" action="{{ route('product1.index') }}">
                    ...
                    <tr
                        ...
                        <td class="px-4 py-3 space-x-2">
                            <a href="{{ route('product1.edit', $item->id) }}"
                                class="inline-block text-sm bg-yellow-400 text-white px-3 py-1 rounded bg-yellow-500 hover:bg-yellow-600 transition">Edit</a>
